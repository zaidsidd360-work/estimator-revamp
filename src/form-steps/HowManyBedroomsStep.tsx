...
const HowManyBedroomsStep: React.FC = () => {
	...
	const { options, label } = formFlowConfig.howManyBedrooms;
	const [selectedOption, setSelectedOption] = useState<string | null>(
		formData.howManyBedrooms || null
	);

	const handleSelection = (label: string) => {
		setSelectedOption(label);
		updateFormData("howManyBedrooms", label);
	};
...
export default HowManyBedroomsStep;
